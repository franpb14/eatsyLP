  ...
  return (
    ...
    <Flip top>
      ...
      <div className="container">
          ...
          <div className="row justify-content-center">
          <div className="col-lg-3 col-6">
              <a  href="https://eatsy-sprint-2.herokuapp.com/"> <img className="comida" src="tortita.png"></img></a>
            </div> 
            <div id="bodyblock1" className="bodyblock col-md-5">
            En <a className="link" href="https://eatsy-sprint-2.herokuapp.com/">este link</a> podrás probar lo último que hemos hecho. Sientete 
